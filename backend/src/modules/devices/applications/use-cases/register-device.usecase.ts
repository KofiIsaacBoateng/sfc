...
import type { RegisterDeviceDto } from "../dtos/register-device.dto.js";
...
export class RegisterDeviceUseCase {
  ...
  async execute(userId: string, dto: RegisterDeviceDto) {
    ...
    return this.unitOfWork.execute(async (repos: Repositories) => {
      ...
      if (!provisionedDevice.isAvailable()) {
        throw new ConflictError(undefined, "Device has already been claimed!");
      }

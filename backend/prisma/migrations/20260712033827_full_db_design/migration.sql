...
-- CreateEnum
CREATE TYPE "SFCDeviceStatus" AS ENUM ('ACTIVE', 'INACTIVE', 'DISABLED', 'LOST');
...
CREATE TABLE "sfc_devices" (
    ...
    "status" "SFCDeviceStatus" NOT NULL DEFAULT 'INACTIVE',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "sfc_devices_hardwareToken_key" ON "sfc_devices"("hardwareToken");
